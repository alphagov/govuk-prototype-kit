...
import { requestHttpsJson, prototypeAppScripts } from "./utils/index.js";
import { projectDir, packageDir, appViewsDir } from "./utils/paths.js";
...
import { encryptPassword as encryptPassword$0 } from "./utils/index.js";
...
// Local dependencies
const encryptPassword = { encryptPassword: encryptPassword$0 }.encryptPassword;
...
function exampleTemplateConfig(packageName, { name, path }) {
    ...
    return {
        name,
        path: { join }.join(packageName, path),
...
export { contextPath };
export { setKitRestarted };
export { getClearDataHandler };
export { postClearDataHandler };
export { getPasswordHandler };
export { postPasswordHandler };
export { developmentOnlyMiddleware };
export { getHomeHandler };
export { getTemplatesHandler };
export { getTemplatesViewHandler };
export { getTemplatesInstallHandler };
export { postTemplatesInstallHandler };
export { getTemplatesPostInstallHandler };
export { getPluginsHandler };
export { getPluginsModeHandler };
export { postPluginsStatusHandler };
export { postPluginsModeMiddleware };
export { postPluginsModeHandler };
export default {
    contextPath,
    setKitRestarted,
    getClearDataHandler,
