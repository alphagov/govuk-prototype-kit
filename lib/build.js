...
const { recursiveDirectoryContentsSync, getInternalGovukFrontendAssets } = require('./utils')
...
function sassKitFrontendDependency () {
  ...
  let fileContents = `$govuk-assets-path: "${getInternalGovukFrontendAssets()}" !default;\n`
  fileContents += internalGovUkFrontendConfig.sass
