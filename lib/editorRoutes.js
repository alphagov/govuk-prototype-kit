...
editorRouter.use('/monaco-editor/min-map', express.static(path.join(projectDir, 'node_modules', 'monaco-editor', 'min-map')))
editorRouter.use('/monaco-editor/min-map', express.static(path.join(packageDir, 'node_modules', 'monaco-editor', 'min-map')))
