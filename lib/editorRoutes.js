...
editorRouter.use('/monaco-editor/min', express.static(path.join(projectDir, 'node_modules', 'monaco-editor', 'min')))
editorRouter.use('/monaco-editor/min', express.static(path.join(packageDir, 'node_modules', 'monaco-editor', 'min')))
editorRouter.use('/monaco-editor/min-maps', express.static(path.join(projectDir, 'node_modules', 'monaco-editor', 'min-maps')))
editorRouter.use('/monaco-editor/min-maps', express.static(path.join(packageDir, 'node_modules', 'monaco-editor', 'min-maps')))
