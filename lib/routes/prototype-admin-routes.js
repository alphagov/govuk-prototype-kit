...
const routerConfig = {useStandardMiddleware: true};
const router = require('../../index').requests.setupRouter(contextPath, routerConfig)
const redirectingRouter = require('../../index').requests.setupRouter('/manage-prototype', routerConfig)
