...
function runErrorServer (error) {
  ...
  const requestListener = function (req, res) {
    ...
    try {
      ...
      fileContentsParts.push('You can try and fix this yourself or <a class="govuk-link" href="https://prototype-kit.service.gov.uk/support/">contact the GOV.UK Prototype Kit team</a> if you need help.')
      fileContentsParts.push('</p>')
