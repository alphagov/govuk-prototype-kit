...
jest.mock('./nunjucks/nunjucksLoader', () => {
  return {
    NunjucksLoader: class NunjucksLoader {},
...
jest.mock('nunjucks', () => {
  ...
  FakeEnvironment.prototype.render = jest.fn()
  FakeEnvironment.renderFn = FakeEnvironment.prototype.render
  class FakeLoader {}

  FakeLoader.extend = jest.fn()
...
describe('manage-prototype-handlers', () => {
  ...
  describe('templates handlers', () => {
    ...
    beforeEach(() => {
      ...
      nunjucks.Environment.renderFn.mockReturnValue(view)
    })
