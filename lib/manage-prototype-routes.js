...
const { getInternalGovukFrontendDir, getInternalGovukFrontendAssets } = require('./utils')
...
router.use(getInternalGovukFrontendAssets(), express.static(path.join(getInternalGovukFrontendDir(), 'govuk', 'assets')))
