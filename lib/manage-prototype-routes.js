...
import { contextPath, setKitRestarted, getClearDataHandler, postClearDataHandler, getPasswordHandler, postPasswordHandler, developmentOnlyMiddleware, getHomeHandler, getTemplatesHandler, getTemplatesViewHandler, getTemplatesInstallHandler, postTemplatesInstallHandler, getTemplatesPostInstallHandler, getPluginsHandler, getPluginsModeHandler, postPluginsModeMiddleware, postPluginsModeHandler, postPluginsStatusHandler } from "./manage-prototype-handlers.js";
import { requests } from "../index.js";
const csrfProtection = csrf({ cookie: false });
const router = { requests }.requests.setupRouter(contextPath);
const redirectingRouter = { requests }.requests.setupRouter('/manage-prototype');
