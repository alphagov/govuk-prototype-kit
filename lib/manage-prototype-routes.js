...
const router = require('../index').requests.setupRouter(contextPath, { includeCoreMiddleware: false })
const redirectingRouter = require('../index').requests.setupRouter('/manage-prototype', { includeCoreMiddleware: false })
