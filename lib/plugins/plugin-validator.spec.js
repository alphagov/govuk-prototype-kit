...
describe('plugin-validator', () => {
  ...
  const validSuccessMessages = phaseOneSuccessMessages.concat([green('The plugin config is valid.')])
  ...
  describe('unexpected keys', () => {
    it('should fail when a key is unknown', async () => {
      ...
      expect(testScope.errLogs).toEqual([red('Error: The following invalid keys exist in your config: myExample')])
