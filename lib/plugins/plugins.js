 ...
 *         }
 *       },
 *       "nunjucksMacros": {"importFrom": path, "macroName": string} | {"importFrom": path, "macroName": string}[],
 *       "nunjucksPaths": path | path[],
 *       "nunjucksFilters": path | path[],
 *       "nunjucksFunctions": path | path[],
 *       "pluginDependencies": [{"packageName": packageName, "minVersion": semVer, "maxVersion": semVer}],
 *       "sass": path | path[],
 *       "scripts": path | path[] | {"path": path, "type": string} | {"path": path, "type": string}[],
