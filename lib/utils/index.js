...
let internalGovukFrontendAssets

function getInternalGovukFrontendAssets () {
  if (!internalGovukFrontendAssets) {
    const internalGovUkFrontendConfig = fse.readJsonSync(path.join(getInternalGovukFrontendDir(), 'govuk-prototype-kit.config.json'))
    internalGovukFrontendAssets = '/manage-prototype/dependencies/govuk-frontend' + internalGovUkFrontendConfig.assets[0]
  }
  return internalGovukFrontendAssets
}
...
module.exports = {
  ...
  getInternalGovukFrontendAssets
}
