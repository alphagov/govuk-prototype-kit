...
const { appDir, projectDir, packageDir, finalBackupNunjucksDir } = require('./paths')
...
const prototypeAppStylesheets = []
if (existsSync(path.join(projectDir, 'app', 'assets', 'javascripts', 'application.js'))) {
  prototypeAppScripts.push('/public/javascripts/application.js')
}
if (plugins.legacyGovukFrontendFixesNeeded()) {
  prototypeAppScripts.push('/plugin-assets/govuk-prototype-kit/lib/assets/javascripts/optional/legacy-govuk-frontend-init.js')
}
if (getConfig().editInBrowser) {
  prototypeAppScripts.push('/plugin-assets/govuk-prototype-kit/lib/assets/javascripts/optional/in-browser-editor.js')
  prototypeAppStylesheets.push('/plugin-assets/govuk-prototype-kit/lib/assets/css/optional/in-browser-editor.css')
}
