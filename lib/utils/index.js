...
const { generateAssetsSync } = require('../build')
...
function confirmAssetsExistSync() {
  const timer = startPerformanceTimer()
  const v13_6_1FilesExist = fs.existsSync('.tmp/sass/legacy-patterns.scss')
  verboseLog('Checking v13.6.1 files exist: ', v13_6_1FilesExist)
  if (!v13_6_1FilesExist) {
    generateAssetsSync()
    endPerformanceTimer('confirmAssetsExistSync - regenerate', timer)
  } else {
    endPerformanceTimer('confirmAssetsExistSync - no action', timer)
  }
}
