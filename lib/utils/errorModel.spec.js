...
describe('getErrorDetails', () => {
  ...
  it('should process a standard Node error', () => {
    expect(getErrorDetails({
      ...
      normalisedFilePath: '/Users/example.user/opensource/alphagov/govuk-prototype-kit/playground.js',
      line: 5,
      column: 9,
  ...
  it('should process a Node reference error', () => {
    expect(getErrorDetails({
      ...
      normalisedFilePath: '/Users/example.user/prototype-kits/companion-prototype-kit/app/routes.js',
      line: 11,
      column: 1,
      processedBy: 'nodeMatchWithLineAndColumnColonSeperatedInBrackets'
    })
  ...
  it('should process a Node end of input error', () => {
    expect(getErrorDetails({
      ...
      normalisedFilePath: '/Users/example.user/opensource/alphagov/govuk-prototype-kit/index.js',
      line: 11,
  ...
  it('should process a node module not found', () => {
    expect(getErrorDetails({
      message: [
  ...
  it('should process windows reference error', () => {
    expect(getErrorDetails({
      ...
      normalisedFilePath: 'X:\\Users\\example.user\\prototype-kits\\companion-prototype-kit\\app\\routes.js',
      processedBy: 'nodeMatchWithLineAndColumnColonSeperatedInBrackets',
      line: 11,
      column: 1
    })
  ...
  it('should process nunjucks windows unexpected variable end error', () => {
    expect(getErrorDetails({
      ...
      normalisedFilePath: 'X:\\Users\\example.user\\prototype-kits\\companion-prototype-kit\\app\\views\\index.njk',
      processedBy: 'nunjucksMatcherWithLineAndColumnSpelledOut',
      line: 13,
      column: 22
    })
  ...
  it('should process windows module not found error', () => {
    expect(getErrorDetails({
      message: `
...
- /Users/example.user/opensource/alphagov/govuk-prototype-kit/listen-on-port.js
  ...
  "useNjkExtensions": true
    ...
    const stack = `SyntaxError: X:\\Users\\example.user\\prototype-kits\\companion-prototype-kit\\app\\config.json: Unexpected string in JSON at position 46
    ...
    expect(getErrorDetails({ message, stack }, fileContents)).toEqual({
      message: 'Unexpected string in JSON',
      filePath: 'X:\\Users\\example.user\\prototype-kits\\companion-prototype-kit\\app\\config.json',
      normalisedFilePath: 'X:\\Users\\example.user\\prototype-kits\\companion-prototype-kit\\app\\config.json',
      line: 4,
      column: 1,
      processedBy: 'nodeMatchWithLineAndColumnColonSeperatedInBrackets'
    })
