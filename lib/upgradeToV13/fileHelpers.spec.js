...
const { mockFileSystem } = require('../../__tests__/util/mockFileSystem')
...
describe('file helpers', () => {
  ...
  describe('replace before line', () => {
    it('should replace before and including an exact match on a single line', async () => {
      ...
      const result = replaceStartOfFile({
        filePath,
        lineToFind,
        replacement
      })

      expect(util.types.isPromise(result)).toBe(true)
  ...
  describe('remove line', () => {
    it('should remove a repeated line from a file', async () => {
      ...
      const result = removeLineFromFile({
        filePath,
        lineToRemove
      })
  ...
  describe('delete file', () => {
    ...
    it('treat deleting a non-existant file as a success', async () => {
      ...
      const result = deleteFile(path.join(projectDir, ...nonexistentFilePath))
  ...
  describe('delete directory', () => {
    it('delete directory that exists', async () => {
      ...
      const result = deleteDirectory(directoryPath)
