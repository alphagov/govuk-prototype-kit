...
function setupAutoStoreDataInRouter(router) {
  if (getConfig().useAutoStoreData) {
    router.use(autoStoreData)
  }
}

function setupAutoStoreDataInNunjucksAppEnv(nunjucksAppEnv) {
  if (getConfig().useAutoStoreData) {
...
module.exports = {
  ...
  autoStoreData,
  setupAutoStoreDataInRouter,
  setupAutoStoreDataInNunjucksAppEnv
}
