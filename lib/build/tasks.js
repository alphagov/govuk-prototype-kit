...
const docsSassPath = path.join(packageDir, paths.docsAssets, 'sass')
const v6SassPath = path.join(projectDir, paths.v6Assets, 'sass')
...
function watch () {
  ...
  watchSass(v6SassPath, v6SassPath, v6CssPath)
