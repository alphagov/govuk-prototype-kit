...
const { tempDir } = require('./path-utils')
const { ensureTempDirExistsSync } = require('./utils')
const usageDataFilePath = path.join(tempDir, 'usage-data-config.json')
