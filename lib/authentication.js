...
function showNoPasswordError (res) {
  ...
  return res.send('<h1>Error:</h1><p>Password not set. <a href="https://prototype-kit.service.gov.uk/publishing/#setting-a-password">See guidance for setting a password</a>.</p>')
}
