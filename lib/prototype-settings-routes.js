...
router.get('/', (req, res) => {
  res.render(path.join('prototype-admin', 'views', 'prototype-settings', 'index.html'))
})
router.get('/data', (req, res) => {
  res.render(path.join('prototype-admin', 'views', 'prototype-settings', 'data.html'))
})
router.get('/extensions', (req, res) => {
  res.render(path.join('prototype-admin', 'views', 'prototype-settings', 'extensions.html'))
})
