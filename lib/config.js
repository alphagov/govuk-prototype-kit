...
const asNumber = inputString => typeof inputString === 'string' ? Number(inputString) : inputString
const asBoolean = inputString => typeof inputString === 'string' ? inputString.toLowerCase() === 'true' : inputString
const asString = inputString => inputString
const asJson = inputString => typeof inputString === 'string' ? JSON.parse(inputString) : inputString
