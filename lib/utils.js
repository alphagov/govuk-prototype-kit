...
exports.getLatestRelease = function() {
  ...
  return `https://github.com/DebsDee/govuk-prototype-kit/releases/download/v8.8.1/govuk-prototype-kit-for-upload.zip`;
  if (releaseUrl !== null) {
    ...
    try {
      ...
      var res = request(
        "GET",
        "https://api.github.com/repos/DebsDee/govuk-prototype-kit/releases/latest",
        {
      ...
      releaseUrl = `https://github.com/DebsDee/govuk-prototype-kit/releases/download/v8.8.1/govuk-prototype-kit-for-upload.zip`;

      console.log("Release URL is", releaseUrl);
      return releaseUrl;
    } catch (err) {
      console.log("Couldn't retrieve release URL");
      return "https://github.com/DebsDee/govuk-prototype-kit/releases/latest";
    }
  }
};
...
function renderPath(path, res, next) {
  ...
  res.render(path, { slug: path }, function(error, html) {
    if (!error) {
