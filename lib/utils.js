...
// Matches routes relative to the given directory
exports.matchRoutes = function(directory, req, res) {

  var path = (req.params[0]);
  res.render(directory + path, function(err, html) {
    if (err) {
      res.render(directory + path + "/index", function(err2, html) {
        if (err2) {
          console.log(err);
