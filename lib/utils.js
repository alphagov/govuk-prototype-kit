  ...
  // Release url doesn't exist
    ...
    try {
        ...
        var data = JSON.parse(res.getBody('utf8')),
            ...
            release_version = zipball_url.split('/').pop(),
            url_start = "https://github.com/alphagov/govuk_prototype_kit/archive/",
            url_end = ".zip";

        zip_url = url_start + release_version + url_end;
        console.log('Release url is', zip_url);
        releaseUrl = zip_url;
        url = releaseUrl;
    }
    catch(err) {
