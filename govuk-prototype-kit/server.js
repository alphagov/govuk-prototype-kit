...
const routes = require(`${userProject}/app/routes.js`)
...
var appViews = extensions.getAppViews([
  path.join(userProject, '/app/views/'),
  path.join(prototypeKitModule, '/lib/')
])
...
app.use('/public', express.static(path.join(userProject, '/public')))

// Serve govuk-frontend in from node_modules (so not to break pre-extensions prototype kits)
app.use('/node_modules/govuk-frontend', express.static(path.join(userProject, '/node_modules/govuk-frontend')))

// Set up documentation app
if (useDocumentation) {
  var documentationViews = [
    path.join(userProject, '/node_modules/govuk-frontend/'),
    path.join(userProject, '/node_modules/govuk-frontend/components'),
    path.join(prototypeKitModule, '/docs/views/'),
    path.join(prototypeKitModule, '/lib/')
  ]
