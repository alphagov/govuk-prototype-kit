...
import filters from "nunjucks/src/filters";
import { waitForApplication } from "../utils.js";
// npm dependencies
const { capitalize } = lodash;
const { urlencode } = filters;
...
export { managePluginsPagePath };
export { manageTemplatesPagePath };
export { loadPluginsPage };
export { loadTemplatesPage };
export { getTemplateLink };
export { performPluginAction };
export { failAction };
export default {
