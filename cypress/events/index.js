...
import { starterDir } from "../../lib/utils/paths.js";
import { sleep } from "../e2e/utils.js";
import { requestHttpsJson } from "../../lib/utils/index.js";
        ...
        return new Promise((resolve, reject) => {
            ...
            const request = https.get(url, response => {
                if (response.statusCode === 200) {
                    ...
                    return download(location, zipFile).then((filename) => resolve(filename));
                }
                else {
