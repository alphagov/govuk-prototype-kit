...
import pluginsApi from "../../lib/plugins/plugins.js";
import sessionApi from "../../lib/session.js";
...
describe('error handling', () => {
    ...
    it('non-fatal errors are not shown in the browser', async () => {
        ...
        expect(console.error).toHaveBeenCalledTimes(1);
        expect(console.error).toHaveBeenCalledWith(expect.stringMatching(/^Error: test non-fatal error/));
