...
import { log, sanitisePaths } from "./logger.js";
import crypto from "crypto";
import { parse } from "../bin/utils/argv-parser.js";
...
export { getFileAsLines };
export { writeFileLinesToFile };
export { replaceStartOfFile };
export { removeLineFromFile };
export { deleteFile };
export { deleteDirectory };
export { deleteDirectoryIfEmpty };
export { copyFileFromStarter };
export { getFileHash };
export { matchAgainstOldVersions };
export { joinLines };
export { verboseLog };
export { handleNotFound };
export { normaliseLineEndings };
export default {
    getFileAsLines,
