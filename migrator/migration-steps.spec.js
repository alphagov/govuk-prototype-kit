...
import { projectDir, starterDir, appDir } from "../lib/utils/paths.js";
import migrationSteps from "./migration-steps.js";
import { preflightChecks, deleteIfUnchanged, removeOldPatternIncludesFromSassFile } from "./migration-steps.js";
jest.mock('fs-extra', () => {
    return {
